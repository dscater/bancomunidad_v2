...
export default {
    ...
    data() {
        return {
            ...
            fields: [
                ...
                {
                    key: "tipo",
                    label: "Tipo de Procesamiento o Ejecución",
                    sortable: true,
                },
                {
    ...
    methods: {
        ...
        editarRegistro(item) {
            ...
            this.oSistema.nombre = item.nombre ? item.nombre : "";
        ...
        abreModal(tipo_accion = "nuevo", sistema = null) {
            this.muestra_modal = true;
            this.modal_accion = tipo_accion;
            if (sistema) {
                this.oSistema = sistema;
            }
        },
